...
**Authentication** 
 ...
 Authentication currently works when run locally outside of the app, as a standalone service. Currently in progress: Wiring the app so it can obtain a JSESSIONID on behalf of the user and use that along with the user credentials to login via LDAP.
